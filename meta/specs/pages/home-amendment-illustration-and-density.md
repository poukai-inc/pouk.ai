...
- **DS-gap proposals filed and accepted**:
  - **Title density**: Arian picked **Lever A** — `<Hero size="intimate">` (or equivalent variant). Proposal **filed 2026-05-17** in `@poukai-inc/poukai-ui` as [poukai-ui#39](https://github.com/poukai-inc/poukai-ui/issues/39); awaits `@poukai-inc/poukai-ui` maintainers acceptance + minor version bump before this amendment ships. (Lever C — content-layer rewrite — is **rejected** by Arian: "copy is fine, font-size is just too big.")
